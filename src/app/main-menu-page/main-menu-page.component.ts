    ...
    <div class="main-menu-container">
      <div class="menu-container light-background">
        ...
        <mat-menu #menu="matMenu">
          ...
          <button *ngIf="userRole === 'admin'" mat-menu-item [routerLink]="'/signup'">Dodaj użytkownika</button>
      ...
      <div class="settings-container">
        <mat-slide-toggle color="primary" [checked]="checked" (change)="onChangeDisplayInformations()">
          {{ typeOfSwitherInformations }}
        </mat-slide-toggle>
        <mat-slide-toggle color="primary" [checked]="AiEnabled" (change)="toggleAi($event.checked)">Włącz sztuczną inteligencję</mat-slide-toggle>
      </div>
      <div class="table-container" *ngFor="let category of typeCategories">
        <button [attr.aria-label]="category.elementType" class="main-menu-single-panel dark-border-button" role="button" *ngIf="!checked" [routerLink]="category.elementType">
          <img [src]="category.icon" alt="Ikona + {{ category.buttonText }}" />
          {{ category.buttonText }}
          <img class="arrow" src="../../assets/Strzalka.svg " aria-label="Przejdź do elementu" />
        </button>
      </div>
      <div class="table-container" *ngFor="let category of positionCategories">
        <button [attr.aria-label]="category.elementPosition" class="main-menu-single-panel dark-border-button" role="button" *ngIf="checked" [routerLink]="category.elementPosition">
          <img [src]="category.icon" alt="Ikona + {{ category.buttonText }}" />
          {{ category.buttonText }}
          <img class="arrow" src="../../assets/Strzalka.svg" aria-label="Przejdź do elementu" />
        </button>
...
export class MainMenuPageComponent implements OnInit {
  ...
  typeCategories: MainMenuCategoryDtos[] = [
    ...
    { buttonText: 'Klimatyzacja', elementType: 'klimatyzacja', icon: '../../assets/Klimatyzacja.svg' },
    { buttonText: 'Zamki', elementType: 'zamek', icon: '../../assets/Zamki.svg' },
  ];
